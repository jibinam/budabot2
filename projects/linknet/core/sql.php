...
class db {
	...
	function formatSql($sql) {
		$sql = str_replace("admin_<myname>", 'admin_linknet', $sql);
		$sql = str_replace("banlist_<myname>", 'banlist_linknet', $sql);
		$sql = str_replace("members_<myname>", 'members_linknet', $sql);

		$sql = str_replace("<dim>", $this->dim, $sql);

		switch ($this->botname) {
			case "linknet":
				$sql = str_replace("<myname>", "master", $sql);
				break;
			case "linknet1":
				$sql = str_replace("<myname>", "slave1", $sql);
				break;
			case "linknet2":
				$sql = str_replace("<myname>", "slave2", $sql);
				break;
			case "linknet3":
				$sql = str_replace("<myname>", "slave3", $sql);
				break;
			case "linknet4":
				$sql = str_replace("<myname>", "slave4", $sql);
				break;
			case "linknet5":
				$sql = str_replace("<myname>", "slave5", $sql);
				break;
			case "linknet6":
				$sql = str_replace("<myname>", "slave6", $sql);
				break;
		}
