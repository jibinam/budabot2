<?php 
	...
	bot::regcommand("msg", "$MODULE_NAME/cmdlist.php", "cmdlist", "admin");
	bot::regcommand("priv", "$MODULE_NAME/cmdlist.php", "cmdlist", "admin");
	bot::regcommand("guild", "$MODULE_NAME/cmdlist.php", "cmdlist", "admin");

	bot::regcommand("msg", "$MODULE_NAME/eventlist.php", "eventlist", "admin");
	bot::regcommand("priv", "$MODULE_NAME/eventlist.php", "eventlist", "admin");
	bot::regcommand("guild", "$MODULE_NAME/eventlist.php", "eventlist", "admin");

	bot::regcommand("msg", "$MODULE_NAME/lookup.php", "lookup", "admin");
	bot::regcommand("priv", "$MODULE_NAME/lookup.php", "lookup", "admin");
	bot::regcommand("guild", "$MODULE_NAME/lookup.php", "lookup", "admin");
