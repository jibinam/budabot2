<?php
	...
	Event::register($MODULE_NAME, "allpackets", "capture.php", "Capture messages from shopping channel");
	Event::register($MODULE_NAME, "24hrs", "remove_old_messages.php", "Remove old shopping messages from the database");
