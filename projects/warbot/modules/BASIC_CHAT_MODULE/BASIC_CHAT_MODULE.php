<?php
	...
	bot::command("", "$MODULE_NAME/topic.php", "edittopic", "all", "Edit topic");
	...
	bot::addsetting($MODULE_NAME, "rally", "Rally for topic", "noedit", "");
	...
	bot::command("", "$MODULE_NAME/rally.php", "rally", "all", "Shows or sets the rally waypoint");
