<?php
	...
	//Commands
	bot::regcommand("msg", "$MODULE_NAME/bot_settings.php", "settings", "admin");
	bot::regcommand("priv", "$MODULE_NAME/bot_settings.php", "settings", "admin");
	bot::regcommand("guild", "$MODULE_NAME/bot_settings.php", "settings", "admin");
	...
	//Help Files
	bot::help($MODULE_NAME, "settings", "settings.txt", "admin", "Change Settings of the Bot");
?>