<?
   ...
   */
    ...
    if($db->numrows() == 0) {
        $msg = "This item does not exist on my database .. sorry. (*new* visit http://aorecipenet.com/)";
	} else {
		...
		$recipes = $db->numrows();
		if ($recipes == 0) {
        	$recipe_msg = "This item is not used in any recipe I know of .. sorry. (*new* visit http://aorecipenet.com/)";
		} else {
