...
/////////////////////////////////////////////////
	...
	$settings['default window color']    = "<font color='#8CB5FF'>";                
	$settings['default tell color']      = "<font color='#00FFFF'>";                     
	$settings['default highlight color'] = "<font color='#FFFF00'>";          
	...
	$settings['DB Type'] = "";              //What type of Database should be used? (Sqlite or Mysql)
    $settings['DB Name'] = "";              // Database Name
	$settings['DB Host'] = "";              // Hostname or File location.
