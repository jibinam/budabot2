...
save_setting_to_db('default_guild_color', $this->settings["default_guild_color"], 'color', null, 'Default Guild Color', null);
save_setting_to_db('default_priv_color', $this->settings["default_priv_color"], 'color', null, 'Default Private Color', null);
save_setting_to_db('default_window_color', $this->settings["default_window_color"], 'color', null, 'Default Window Color', null);
save_setting_to_db('default_tell_color', $this->settings["default_tell_color"], 'color', null, 'Default Tell Color', null);
save_setting_to_db('default_highlight_color', $this->settings["default_highlight_color"], 'color', null, 'Default Highlight Color', null);
save_setting_to_db('default_header_color', $this->settings["default_header_color"], 'color', null, 'Default Header Color', null);
save_setting_to_db('default_error_color', $this->settings["default_error_color"], 'color', null, 'Default Error Color', null);
