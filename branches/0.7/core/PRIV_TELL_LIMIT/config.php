...
if (preg_match("/^limits$/i", $message)) {
	...
	$list .= "<end> (";
	$list .= Links::makeLink("Change this", "/tell <myname> limit tell faction", "chatcmd").")\n";
	...
	$list .= "<end> (";
	$list .= Links::makeLink("Change this", "/tell <myname> limit tell minlvl", "chatcmd").")\n";
	...
	$list .= "<end> (";
	$list .= Links::makeLink("Change this", "/tell <myname> limit tell open", "chatcmd").")\n";

	$list .= "\n<u>Privatgroup Invites</u>\n";
	$list .= "Faction: <highlight>{Settings::get("priv_req_faction")}<end> (";
	$list .= Links::makeLink("Change this", "/tell <myname> limit priv faction", "chatcmd").")\n";
	$list .= "Level: <highlight>";
	...
	$list .= "<end> (";
	$list .= Links::makeLink("Change this", "/tell <myname> limit priv minlvl", "chatcmd").")\n";
	$list .= "General: <highlight>";
	...
	$list .= Links::makeLink("Change this", "/tell <myname> limit priv open", "chatcmd").")\n";
	...
	$list .= "<end> (";
	$list .= Links::makeLink("Change this", "/tell <myname> limit priv maxplayers", "chatcmd").")\n";

	$msg = Links::makeLink("Limits for privGroup and Tells", $list);
	...
	$list .= "<end>\n\nChange it to:\n";
	$list .= Links::makeLink("No Faction Limit", "/tell <myname> limit {$arr[1]} faction all", "chatcmd")."\n\n";	
	$list .= Links::makeLink("Omni only", "/tell <myname> limit {$arr[1]} faction omni", "chatcmd")."\n";
	$list .= Links::makeLink("Clan only", "/tell <myname> limit {$arr[1]} faction clan", "chatcmd")."\n";	
	$list .= Links::makeLink("Neutral only", "/tell <myname> limit {$arr[1]} faction neutral", "chatcmd")."\n\n";
	$list .= Links::makeLink("Not Clan", "/tell <myname> limit {$arr[1]} faction not clan", "chatcmd")."\n";
	$list .= Links::makeLink("Not Neutral", "/tell <myname> limit {$arr[1]} faction not neutral", "chatcmd")."\n";
	$list .= Links::makeLink("Not Omni", "/tell <myname> limit {$arr[1]} faction not omni", "chatcmd")."\n";
	$msg = Links::makeLink("Faction Limit", $list);
	$this->send($msg, $sender);
	...
	$list .= "<end>\n\nChange it to:\n";
	$list .= Links::makeLink("No Level limit", "/tell <myname> limit {$arr[1]} minlvl 0", "chatcmd")."\n\n";	
	for($i = 5; $i <= 220; $i+=5)
		$list .= Links::makeLink("Level limit $i", "/tell <myname> limit {$arr[1]} minlvl $i", "chatcmd")."\n";

	$msg = Links::makeLink("Level Limit", $list);
	$this->send($msg, $sender);
	...
	$list .= "<end>\n\nChange it to:\n";
	$list .= Links::makeLink("No General limit", "/tell <myname> limit {$arr[1]} open all", "chatcmd")."\n\n";
	$list .= Links::makeLink("Only for Members of your Organisation", "/tell <myname> limit {$arr[1]} open org", "chatcmd")."\n";
	$list .= Links::makeLink("Only for Members of the Bot", "/tell <myname> limit {$arr[1]} open members", "chatcmd")."\n\n";

	$msg = Links::makeLink("General Limit", $list);
	$this->send($msg, $sender);
	...
	$list .= "<end>\n\nChange it to:\n";
	$list .= Links::makeLink("No Limit of Players", "/tell <myname> limit priv maxplayers 0", "chatcmd")."\n\n";	
	for($i = 6; $i <= 120; $i+=6)
		$list .= Links::makeLink("Set Maximum allowed Players in the Bot to $i", "/tell <myname> limit priv maxplayers $i", "chatcmd")."\n";

	$msg = Links::makeLink("Limit of Players in the Bot", $list);
	$this->send($msg, $sender);
