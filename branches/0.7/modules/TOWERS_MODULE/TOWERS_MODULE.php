<?php
	...
	$this->addsetting("tower_attack_spam", $MODULE_NAME, "Layout types when displaying tower attacks", "edit", "1", "off;compact;normal;full", '0;1;2;3', MODERATOR);
	$this->addsetting("tower_faction_def", $MODULE_NAME, "Display certain factions defending", "edit", "7", "none;clan;neutral;clan+neutral;omni;clan+omni;neutral+omni;all", '0;1;2;3;4;5;6;7', MODERATOR);
	$this->addsetting("tower_faction_atk", $MODULE_NAME, "Display certain factions attacking", "edit", "7", "none;clan;neutral;clan+neutral;omni;clan+omni;neutral+omni;all", '0;1;2;3;4;5;6;7', MODERATOR);
