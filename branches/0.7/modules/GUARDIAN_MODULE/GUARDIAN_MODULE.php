<?php
	...
	//Guardian module
	Event::register("leavePriv", $MODULE_NAME, "left_chat.php", "Remove player who leaves chat from guardian list if he was on it");
	Event::register("joinPriv", $MODULE_NAME, "joined_chat.php", "Add player to guardian list when he joins chat if he should be on it (Soldier)");
