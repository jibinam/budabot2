 ...
 * Help Omni to attack :
   ...
   <font color=#4169e1>Warning</font> Towers will attack you if you are in range,<font color=#ff0000> so remember to turn off the auto attack (and pet on /follow)!.</font>
   <font color=#4169e1>Warning</font> you have to ask for and recieve approuval  from a senior member of NA (general or prez)
...
And please, post your twinks or twinks project in <a href='chatcmd:///start http://naers.1.forumer.com/index.php?showtopic=70'><font color = yellow>Official Forums Thread</font></a> so I can update our roster !!


And remember : <font color=#ff0000>TURN AUTO ATTACK : OFF and Pet on /follow !</font>";

$napvp_txt = Links::makeLink("Newcomers Alliance PvP Rules", $napvp_txt);
if($type == "msg")
