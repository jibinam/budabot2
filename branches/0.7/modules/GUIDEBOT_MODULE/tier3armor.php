...
$tier3armor_txt = Text::makeLink("Making Tier 3 Chosen/Faithful Armor", $tier3armor_txt); 
if($type == "msg") 
$chatBot->send($tier3armor_txt, $sender); 
elseif($type == "all") 
$chatBot->send($tier3armor_txt); 
else 
$chatBot->send($tier3armor_txt, "guild"); 
?>