...
"
;
$elykeyclan_txt = Text::makeLink("Elysium: Garden Key Quest Clan", $elykeyclan_txt); 
if($type == "msg") 
$chatBot->send($elykeyclan_txt, $sender); 
elseif($type == "all") 
$chatBot->send($elykeyclan_txt); 
else 
$chatBot->send($elykeyclan_txt, "guild"); 
?>