...
<font color = yellow>Chapter Two. Breed.</font>

<font color = green>Well, as you know, entering Rubi-Ka gets you are genetically altered to one of 4 breeds. Whilst personally I am a nanomage (don't you just love the glowing blue eyes!), I will look at each of the breeds as best as I can.</font>
...
<font color = yellow>Chapter Three. Abilities and Skills.</font>
...
Some mobs are immune to calms - period. However you get exactly the same message off other mobs. I will use Legchopper as my nanotech.
...
<font color = green>What IS nano programming</font>, I've mentioned it before but haven't said what it is! Well its very simple, you can stick things in your body to improve your self, they are called implants. Well nano programming is the creation of implants. Ok the first thing you do is grab this little tool Nano Nanny. Ok its got an odd name, but it allows you to design your implants, mess around and get some idea of what they are going to do! Ok now its VERY simple to make an implant.
...
$nanotech_txt = Links::makeLink("Guide to Nano Technicians", $nanotech_txt);
