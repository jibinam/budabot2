...
<FONT COLOR = Yellow>To send a private message:</FONT>
/tell PLAYERNAME MESSAGE

<FONT COLOR = Yellow>To add a friend to your friend list just type:</FONT>
/cc addbuddy PLAYERNAME

Notice the /
The / means you're sending a command to the game. For more information try /help

<FONT COLOR = Yellow>To reply to a private message from the last person that sent you one:</FONT>
SHIFT+R
...
<FONT COLOR = Yellow>What is a whom-pa?</FONT>
...
<FONT COLOR = Yellow>What is the grid?</FONT>
...
<FONT COLOR = Yellow>What can I do if I find myself stuck in the worlds geometry?</FONT>
...
<FONT COLOR = Yellow>What is the Abandoned Subway, and where can I find it?</FONT>
...
<FONT COLOR = Yellow>Where can I get missions? How do I find the mission once I've received it?</FONT>
...
<FONT COLOR = Yellow>How can I change my name?</FONT>
...
<FONT COLOR = Yellow>Where and how do I save my character?</FONT>
...
<FONT COLOR = Yellow>Do I lose items or credits if I die during PvP?</FONT>
...
<FONT COLOR = Yellow>How can I get an Apartment? What if I want to get a new apartment? Can I have more then one Apartment?</FONT>
...
<FONT COLOR = Yellow>How do I get help if I'm stuck or need assistance?</FONT>
...
<FONT COLOR = Yellow>What is Over Equipping (OE)?</FONT>
...
<FONT COLOR = Yellow>How do I install implants?</FONT>
...
<FONT COLOR = Yellow>How do I trade with players? Is it secure?</FONT>
...
<FONT COLOR = RED>ALL TRADES ARE FINAL!</FONT>

<FONT COLOR = Yellow>How can I see a description of an item or person?</FONT>
...
";
$beginners_txt = Links::makeLink("Beginner's FAQs", $beginners_txt); 
if($type == "msg") 
