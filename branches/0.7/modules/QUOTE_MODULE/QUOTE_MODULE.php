<?php
	...
	$this->addsetting("quote_add_min", $MODULE_NAME, "Minimum org level needed to add quote.", "edit", "-1", "Anyone;At least in Private chat;0;1;2;3;4;5;6", "-2;-1;0;1;2;3;4;5;6", MODERATOR);
	$this->addsetting("quote_stat_count", $MODULE_NAME, "Number of users shown in stats.", "edit", "10", "number", "0", MODERATOR);
?>