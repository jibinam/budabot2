<?php
	...
	Command::register($MODULE_NAME, "altsadmin.php", "altsadmin", MODERATOR, "Alt Char handling (admin)");
    ...
    Help::register($MODULE_NAME, "tell.txt", "tell_guild", GUILDMEMBER, "How to use tell and tellall");
?>