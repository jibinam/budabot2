<?php 
	...
	Command::register($MODULE_NAME, "topic.php", "topic (.+)", LEADER, "Change Topic");
	...
	Command::register($MODULE_NAME, "leader.php", "leader (.+)", LEADER, "Set a specific Leader");
	...
	Event::register("leavePriv", $MODULE_NAME, "leader.php", "Removes leader when the leader leaves the channel");
	...
	Command::register($MODULE_NAME, "assist.php", "assist (.+)", LEADER, "Set a new assist");
	Command::register($MODULE_NAME, "heal_assist.php", "heal", ALL, "Creates/showes an Doc Assist macro");
	Command::register($MODULE_NAME, "heal_assist.php", "heal (.+)", LEADER, "Set a new Doc assist");
	...
	//Updateme
	Command::register($MODULE_NAME, "updateme.php", "updateme", ALL, "Updates char info for a player");
